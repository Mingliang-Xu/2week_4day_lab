...
const result = numbers.forEach(element=> console.log(element/=2));
...
const dividedBy2 = numbers.forEach((element) => {
...
const citiesWithI = cities.filter( element => element.includes('i'));
...
const AppleOrOrange = fruits.forEach(element => {
...
const foodWithRice = foods.filter(element => element.tags.includes('rice'))

console.log(foodWithRice);

const totalPriceOfFoodWithRice = foodWithRice.reduce((arr, curr) => arr + curr.price,0);

console.log(totalPriceOfFoodWithRice);

// The Result is: 36

// const chainingMethods = foods.filter(element => element.tags.includes('rice')).reduce((arr, curr) => arr + curr.price,0);
